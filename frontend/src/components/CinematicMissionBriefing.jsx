...
const MISSION_STEPS = [
  { text: 'INITIALIZING ORBIT VISION AI', sub: 'Neural Threat Detection Engine', delay: 500 },
  { text: 'SCANNING 47 SERVICES', sub: 'Distributed topology analysis active', delay: 2000 },
  { text: '3 CRITICAL VULNERABILITIES DETECTED', sub: 'Payment Gateway — Billing — Auth Services', delay: 3500 },
  { text: 'BLAST RADIUS ESTIMATE: $2.8M', sub: 'Executive action required within 24 hours', delay: 5000 },
  { text: 'MISSION BRIEFING ACTIVE', sub: 'All systems nominal. Ready for executive command.', delay: 6500 },
]
                ...
                {MISSION_STEPS.map((_, i) => (
                  <div
                    ...
                    className={`h-0.5 w-6 rounded-full transition-all duration-500 ${
                      i <= step ? 'bg-cyan-500/80' : 'bg-white/[0.06]'
                    }`}
                  />
                ))}
              </div>
          ...
          <AnimatePresence mode="wait">
            {step < MISSION_STEPS.length ? (
              ...
              >
                ...
                />
                <h1 className="text-2xl sm:text-3xl font-bold tracking-[0.3em] text-white mb-3">
              ...
              >
                ...
                <h1 className="text-lg font-bold tracking-[0.2em] text-white mb-2">
                  MISSION READY
                </h1>
                <p className="text-[10px] font-mono text-slate-500">
                  All systems nominal. Proceed to command interface.
                </p>
              </motion.div>
            )}
          </AnimatePresence>
